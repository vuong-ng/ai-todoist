...
import {
  Bold, Code, Heading1, Heading2,
  Heading3, Heading4, Heading5, Heading6, Italic, List, ListOrdered,
  Quote, Redo, Strikethrough, Undo,
} from 'lucide-react'
...
const TipTapMenuBar = ({editor} : {editor: Editor}) => {
  return (
    <div className='flex flex-wrap gap-2'>
      ...
      <button
        onClick={() => editor.chain().focus().focus().redo().run()}
